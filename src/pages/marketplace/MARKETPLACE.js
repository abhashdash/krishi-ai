...
const recommendedProducts = [
  {
    ...
    price: 15000,
    image: "https://images.pexels.com/photos/1301856/pexels-photo-1301856.jpeg?auto=compress&cs=tinysrgb&w=250&h=150"
  },
  {
    id: 102,
    name: "Soil Testing Kit",
    price: 2500,
    image: "https://images.pexels.com/photos/1072824/pexels-photo-1072824.jpeg?auto=compress&cs=tinysrgb&w=250&h=150"
  },
  {
    id: 103,
    name: "Weather Monitor",
    price: 5200,
    image: "https://images.pexels.com/photos/714258/pexels-photo-714258.jpeg?auto=compress&cs=tinysrgb&w=250&h=150"
  },
  {
    id: 104,
    name: "Solar Water Pump",
    price: 45000,
    image: "https://images.pexels.com/photos/159397/solar-panel-array-power-sun-electricity-159397.jpeg?auto=compress&cs=tinysrgb&w=250&h=150"
  }
];
...
const FAVORITES_KEY = 'krishi_favorites_v1';
      ...
      <div class="product-info">
        ...
        <div class="product-actions">
          ...
          <button class="favorite-btn" data-id="${product.id}" title="Add to wishlist">
            ${isFavorite(product.id) ? '<i class="fas fa-heart" style="color:#d9534f"></i>' : '<i class="far fa-heart"></i>'}
          </button>
        </div>
      </div>
    </div>
...
function setupEventListeners() {
  ...
  // Favorite (wishlist) button handler - event delegation
